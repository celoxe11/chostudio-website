...
<body class="flex flex-row items-center h-screen">
    ...
    <div class="flex flex-col items-center h-full bg-[#f0ebe3] w-[25%]">
        ...
        {{-- socials --}}
        <div class="link-socials flex flex-row items-center gap-1 w-fit">
            {{-- insta --}}
    ...
    {{-- isi konten halaman --}}
    <div
        class="content h-full w-full flex items-center justify-center bg-[url('/assets/images/Background.png')] bg-no-repeat bg-cover">
        <div
            ...
            {{-- Recent Works --}}
            <div class="recentworks bg-blue-300 h-full font-[HammersmithOne-Regular]">
                <h1 class="text-2xl md:text-3xl lg:text-4xl">Recent Works</h1>
