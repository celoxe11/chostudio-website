    ...
    <div class="p-4 xl:w-[80%] mx-auto lg:w-full">
        @php
            ...
            $gallery = (object) [
                ...
                'description' => 'A fierce dragon humanoid warrior character with detailed armor and mystical powers. Perfect for fantasy stories or RPG characters.',
        ...
        <div class="shadow font-[HammersmithOne-Regular]">
            ...
            <div class="bg-white border-2 border-t-0 border-stone-900 p-6 min-h-fit">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 auto-rows-min">
                    ...
                    <!-- Artwork Section -->
                    <div class="space-y-6">
                        <h2 class="text-2xl font-bold text-stone-900 border-b-2 border-stone-300 pb-2">Artwork Information</h2>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <div class="text-lg font-bold text-green-600">Rp {{ number_format($gallery->price, 0, ',', '.') }}</div>
                                </div>
                            </div>
                        </div>

                        <h2 class="text-2xl font-bold text-stone-900 border-b-2 border-stone-300 pb-2">Order Information</h2>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="text-gray-800">{{ date('F j, Y \a\t g:i A', strtotime($adoption->created_at)) }}</div>
                            </div>
                        ...
                        <div class="pt-6 border-t-2 border-stone-200">
                            ...
                            <div class="flex flex-col sm:flex-row gap-3">
                                @if($adoption->order_status === 'Pending')
                                    <button class="px-6 py-3 rounded-lg border-2 border-blue-500 text-white font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200"
                                            style="background-color: var(--status-info);">
                                        Confirm Order
                                    </button>
                                    <button class="px-6 py-3 rounded-lg border-2 border-red-600 text-white font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200"
                                            style="background-color: var(--status-danger);">
                                        Reject Order
                                    </button>
                                @elseif($adoption->order_status === 'Confirmed')
                                    <button class="px-6 py-3 rounded-lg border-2 border-green-600 text-white font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200"
                                            style="background-color: var(--status-success);">
                                        Mark as Delivered
                                    </button>
                                @endif
                                
                                <button class="px-6 py-3 rounded-lg border-2 border-gray-500 bg-gray-100 text-gray-700 font-semibold shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200">
                                    Contact Buyer
                                </button>
