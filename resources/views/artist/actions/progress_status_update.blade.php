<div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 border-2 border-blue-200">
    ...
    <div class="flex gap-3">
        <select id="progress_status" name="progress_status"
            ...
            <option value="In Progress" {{ $commission->progress_status === 'in_progress_sketch' ? 'selected' : '' }}>
                In Progress (Sketch)
            </option>
            <option value="In Progress" {{ $commission->progress_status === 'in_progress_coloring' ? 'selected' : '' }}>
